 ...
 */
const buildStatusMap: Record<string, FilterStatusType> = {
  running: 'running',
  scheduled: 'scheduled',
  passed: 'succeeded',
  failing: 'failed',
...
/**
 * Takes the build object from Buildkite and transforms it to the Build object.
 *
...
/**
 * Takes the Job object from Buildkite and transforms it to the Stage object
 *
